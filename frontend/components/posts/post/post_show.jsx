...
class PostShow extends React.Component {
     ...
     handleDelete(e) {
         e.preventDefault();
         window.confirm("Are you sure you want to delete this post?") && this.props.deletePost(this.props.post.id)
        ...
        return (
            <div>
                ...
                <div className="post-box">
                    <img className="post-show-image" className="post-show-image" src={photoUrl}/>
                    <div className="post-show-detail-box">
                        <div className="post-author">
                            <div className="post-author-links">
                             ...
                             <div className="post-author-delete">{user_id === this.props.currentUser.id || this.props.currentUser.username === "InstaThronesAdmin"?(
